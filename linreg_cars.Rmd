...
manual car. The difference is statistically significant (p-value = $`r summary(fit.wt)$coeff[2,4]`$ < 0.05). This implies that we should also
...
have significant impact on the intercept (p-value = $`r summary(fit.wt.am)$coeff[2,4]`$ > 0.05).
